...
TIME_FOR_USER_INTERACTIONS = 20
MAX_TIMES_TO_SIGN = 60
    ...
    try:
        ...
        while repeat:
            try:
                ...
                print('User did not sign. Trying again.')
                if numTries == MAX_TIMES_TO_SIGN:
                    print('User failed to sign in the given time.')
